...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Rule-based diagnosa
        if ($gejala10 == 'ya') {
            $diagnosis = header("location: jawaban1.php"); exit(); //melink ke gejala 6
        } else {
    ...
    <form method="POST" action="">
        ...
        <div class = "pf">
            ...
            <p>Apakah penyakit ini dapat menular ke manusia ?</p>
            <div class="inputGroup">
                <input id="radio1" name="gejala10" type="radio" value="ya" required/>
                <label for="radio1">ya</label>
            </div>
            <div class="inputGroup">
                <input id="radio2" name="gejala10" type="radio" value="tidak" required/>
