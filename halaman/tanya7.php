...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Rule-based diagnosa
        if ($gejala7 == 'ya') {
            $diagnosis = header("location: jawaban4.php"); exit(); //melink ke gejala 6
        } else {
    ...
    <form method="POST" action="">
        ...
        <div class = "pf">
            ...
            <p>Apakah ada pembengkakan pada bagian dagu ?</p>
            <div class="inputGroup">
                <input id="radio1" name="gejala7" type="radio" value="ya" onClick='top.location="jawaban4.php"' required/>
                <label for="radio1">ya</label>
            </div>
            <div class="inputGroup">
                <input id="radio2" name="gejala7" type="radio" value="tidak" required/>
